...
- [ ] Reis password to protect against compromised-container attacks

## Dev Containers

- [ ] Add [Dev Containers](https://containers.dev/) so you can debug the app container during development.
